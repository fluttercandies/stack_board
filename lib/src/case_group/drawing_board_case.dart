...
//     this.onDel,
//     this.operatState = OperatingState.editing,
//     this.onTap,
//   }) : super(key: key);
...
//   void initState() {
//     super.initState();
//     _operatState = widget.operatState ?? OperatingState.editing;
...
//       onOperatStateChanged: (OperatingState os) {
//         if (os == OperatingState.editing && !_isEditing) {
//           _isEditing = true;
//           safeSetState(() {});
//         } else if (os != OperatingState.editing && _isEditing) {
//           _isEditing = false;
//           safeSetState(() {});
//         }
